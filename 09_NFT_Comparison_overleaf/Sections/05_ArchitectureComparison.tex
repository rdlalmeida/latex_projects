...
\begin{table}[ht]
    \centering
    \caption{Gas consumption report from Hardhat's gas reported tool.}
    \label{tab:solidity_gas_reporter}
    \resizebox{\columnwidth}{!}{%
        \begin{tabular}{|ll|l|ll|}
            \hline
            \multicolumn{2}{|l|}{Solc version: 0.8.24} & \multirow{2}{*}{Runs: 200}                  & \multicolumn{2}{l|}{\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Block limit:\\ 6718946 gas\end{tabular}}}                                             \\ \cline{1-2}
            \multicolumn{2}{|l|}{Methods}              &                                             & \multicolumn{2}{l|}{}                                                                                                                                \\ \hline
            \multicolumn{1}{|l|}{Contract}             & Method                                      & Avg                                                                                                      & \multicolumn{1}{l|}{\# calls} & eur (avg) \\ \hline
            \multicolumn{1}{|l|}{ExampleNFT}           & burn(uint256)                               & 29592                                                                                                    & \multicolumn{1}{l|}{1}        & 0.8091    \\ \hline
            \multicolumn{1}{|l|}{ExampleNFT}           & safeMint(address, uint256, string)          & 121859                                                                                                   & \multicolumn{1}{l|}{2}        & 3.3312    \\ \hline
            \multicolumn{1}{|l|}{ExampleNFT}           & safeTransferFrom(address, address, uint256) & 58401                                                                                                    & \multicolumn{1}{l|}{2}        & 1.5973    \\ \hline
            \multicolumn{2}{|l|}{Deployments}          & 2420549                                     & \multicolumn{1}{l|}{36 \%}                                                                               & 66.205                                    \\ \hline
            \multicolumn{2}{|l|}{Totals}               & 2630401                                     & \multicolumn{1}{l|}{}                                                                                    & 71.943                                    \\ \hline
        \end{tabular}%
    }
\end{table}
...
\begin{table}[ht]
    ...
    \resizebox{\columnwidth}{!}{%
        \begin{tabular}{ccccc}
            ...
            \multicolumn{1}{|c|}{}                             & \multicolumn{1}{c|}{\textbf{Contract Size}}                                    & \multicolumn{1}{c|}{\textbf{Simple Storage}} & \multicolumn{1}{c|}{\textbf{Mapping Storage}} & \multicolumn{1}{c|}{\textbf{Total (Bytes)}} \\ \hline
